        ...
        "undefined" == typeof DayPilot.Global && (DayPilot.Global = {}),
            ...
            DayPilot.absOffsetBased = function (e, t) {
                for (var a = {
                    ...
                    }; e.offsetParent;) e = e.offsetParent, a.x -= e.scrollLeft, a.y -= e.scrollTop, t && (a.x < 0 && (a.w += a.x, a.x = 0),
                    a.y < 0 && (a.h += a.y, a.y = 0), e.scrollLeft > 0 && a.x + a.w > e.clientWidth && (a.w -= a.x + a.w - e.clientWidth), e.scrollTop && a.y + a.h > e.clientHeight && (a.h -= a.y + a.h - e.clientHeight)), a.x += e.offsetLeft, a.y += e.offsetTop;
            ...
            DayPilot.request = function (e, t, a, r) {
                ...
                o && (o.open("POST", e, !0),
                    ...
                    o.onreadystatechange = function () {
                        if (4 === o.readyState) return 200 !== o.status && 304 !== o.status ?
                            void(r ? r(o) : window.console && console.log("HTTP error " + o.status)) : void t(o)
            ...
            DayPilot.Locale.register(new DayPilot.Locale("ua-ua", {
            ...
            switch (m && "object" == typeof m && "function" == typeof m.toJSON2 ? m = m.toJSON2(e) : m && "object" == typeof m && "function" == typeof m.toJSON && !m.ignoreToJSON && (m = m.toJSON(e)), "function" == typeof n && (m = n.call(i, e, m)), typeof m) {
                ...
                case "object":
                    ...
                    if (n && "object" == typeof n)
                        for (u = n.length, d = 0; d < u; d += 1) l = n[d], "string" == typeof l && (s = a(l, m), s && c.push(t(l) + (r ? ": " : ":") + s));
                    else
                        for (l in m) Object.hasOwnProperty.call(m, l) && (s = a(l, m), s && c.push(t(l) + (r ? ": " : ":") + s));
                    return s = 0 === c.length ? "{}" : r ? "{\n" + r + c.join(",\n" + r) + "\n" + f + "}" : "{" + c.join(",") + "}", r = f, s
            }
        }
        ...
        if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
            ...
            t.selectedCells = [],
                ...
                t.gMouseUp = function (i) {
                    if (t.resizing) {
                        if (!t.resizingShadow)
                            return t.resizing.style.cursor = "default", document.body.style.cursor = "default",
                        ...
                        t.deleteShadow(t.resizingShadow),
                            ...
                            t.resizing.onclick = null, t.resizing = null,
                            n.calendar.a(n, s, a, l)
                    } else if (t.moving) {
                        if (!t.movingShadow) return t.moving = null,
                            oid(document.body.style.cursor = "default");
                ...
                t.Calendar = function (e, i) {
                    ...
                    this.uniqueID = null,
                        ...
                        this.m = function (e, t, i) {
                            ...
                            var a = "JSON" + DayPilot.JSON.stringify(n);
                            this.backendUrl ?
                                DayPilot.request(this.backendUrl, this.n, a, this.ajaxError) :
                                "function" == typeof WebForm_DoCallback && WebForm_DoCallback(this.uniqueID, a, this.o, this.clientName, this.onCallbackError, !0)
                        },
                        ...
                        this.dispose = function () {
                            ...
                            e.p(), e.nav.scroll.root = null, DayPilot.pu(e.nav.loading), e.q(), e.r(), e.nav.select = null,
                                e.nav.cornerRight = null, e.nav.scrollable = null, e.nav.zoom = null, e.nav.loading = null, e.nav.header = null,
                                e.nav.hourTable = null, e.nav.scrolltop = null, e.nav.scroll.onscroll = null, e.nav.scroll = null, e.nav.main = null,
                                e.nav.message = null, e.nav.messageClose = null, e.nav.top = null, t.unregister(e)
                        },
                        this.s = function () {
                        ...
                        this.l = function () {
                            var e = {};
                            return e.control = "dpc", e.id = this.id, e.v = this.v, e.days = s.days, e.startDate = s.startDate, e.heightSpec = s.heightSpec,
                                e.businessBeginsHour = s.businessBeginsHour, e.businessEndsHour = s.businessEndsHour, e.hashes = s.hashes,
                                e.timeFormat = s.timeFormat, e.viewType = s.viewType, e.locale = s.locale, e
                        },
                        this.t = function (e, t) {
                            ...
                            return a.className = s.u("_shadow_inner"),
                                n.appendChild(a), i.firstChild.appendChild(n), n
                        },
                        this.w = {},
                    ...
                    this.o = function (e, t) {
                            ...
                            if (s.p(),
                                "Full" === e.UpdateType && (s.columns = e.Columns,
                                    s.days = e.Days,
                                    ...
                                    s.viewType = e.ViewType, s.backColor = e.BackColor ? e.BackColor : s.backColor,
                                    s.eventHeaderVisible = e.EventHeaderVisible ? e.EventHeaderVisible : s.eventHeaderVisible,
                                    s.timeFormat = e.TimeFormat ? e.TimeFormat : s.timeFormat, s.locale = e.Locale ? e.Locale : s.locale, s.B()), e.Hashes)
                                for (var i in e.Hashes) s.hashes[i] = e.Hashes[i];
                            s.events.list = e.Events, s.C(), s.D(),
                                "Full" === e.UpdateType && (s.E(), s.F(), s.G(), s.H()), s.A(), s.I(),
                                s.clearSelection(), s.afterRender(e.CallBackData, !0), s.loadingStop()
                        },
                        this.J = function () {
                            return this.K() / 36e5
                        },
                        ...
                        this.K = function () {
                            var e = 0;
                            return e = "BusinessHoursNoScroll" === this.heightSpec ?
                                this.L() :
                                24 /* тут було 24*/ , 60 * e * 60 * 1e3
                        },
                        this.L = function () {
                        ...
                        this.N = function () {
                            return "BusinessHoursNoScroll" === this.heightSpec ?
                                ...
                                0 // this.businessBeginsHour //тут було 0
                        },
                        //-------------------
                        this.O = function () {
                            return 2 === s.api
                        ...
                        this.P = function (e) {
                            ...
                            if (s.O()) {
                                ...
                                if (n.e = i, n.originalEvent = e, n.meta = e.metaKey, n.ctrl = e.ctrlKey, n.control = s, n.preventDefault = function () {
                                    ...
                                    }, "function" == typeof s.onEventClick && (s.Q.apply(function () {
                                        s.onEventClick(n)
                                ...
                                "function" == typeof s.onEventClicked && s.Q.apply(function () {
                                    s.onEventClicked(n)
                                })
                        ...
                        this.S = function (e) {
                            if (s.O()) {
                                ...
                                if (t.e = e, t.control = s, t.preventDefault = function () {
                                        this.preventDefault.value = !0
                                    }, "function" == typeof s.onEventDelete && (s.Q.apply(function () {
                                        s.onEventDelete(t)
                                ...
                                "function" == typeof s.onEventDeleted && s.Q.apply(function () {
                                    s.onEventDeleted(t)
                                })
                        ...
                        this.a = function (e, t, i, n) {
                            ...
                            if (s.O()) {
                                ...
                                if (f.e = e, f.control = s, f.newStart = l, f.newEnd = o, f.preventDefault = function () {
                                        this.preventDefault.value = !0
                                    }, "function" == typeof s.onEventResize && (s.Q.apply(function () {
                                        s.onEventResize(f)
                                ...
                                "function" == typeof s.onEventResized && s.Q.apply(function () {
                                    s.onEventResized(f)
                                })
                        ...
                        this.b = function (e, t, i, n) {
                            ...
                            if (s.O()) {
                                ...
                                if (b.e = e, b.newStart = m, b.newEnd = y, b.newResource = p, b.ctrl = n.ctrlKey, b.shift = n.shiftKey, b.control = s, b.preventDefault = function () {
                                        this.preventDefault.value = !0
                                    }, "function" == typeof s.onEventMove && (s.Q.apply(function () {
                                        s.onEventMove(b)
                                ...
                                "function" == typeof s.onEventMoved && s.Q.apply(function () {
                                    s.onEventMoved(b)
                                })
                        ...
                        this.c = function (e, t, i) {
                            if (e = new DayPilot.Date(e), t = new DayPilot.Date(t), this.O()) {
                                ...
                                if (n.start = e, n.end = t, n.resource = i, n.control = s, n.preventDefault = function () {
                                        this.preventDefault.value = !0
                                    }, "function" == typeof s.onTimeRangeSelect && (s.Q.apply(function () {
                                ...
                                "function" == typeof s.onTimeRangeSelected && s.Q.apply(function () {
                                ...
                                if (a) {
                                    var l = a.start,
                                        ...
                                        c = function () {
                                            ...
                                            var t = document.createElement("div");
                                            return t.setAttribute("unselectable", "on"), t.className = s.u("_shadow_inner"), e.appendChild(t),
                                                s.nav.events.rows[0].cells[n].selection.appendChild(e), s.elements.selection.push(e), s.nav.activeSelection = e, e
                                        }();
                        ...
                        this.Y = {}, this.Y.getCellCoords = function () {
                            var e = {};
                        ...
                        this.B = function () {
                            var e;
                            e = "Resources" !== s.viewType ? this.$() : s.columns.list, this.T = [];
                        ...
                        this.visibleStart = function () {
                            if ("Resources" === s.viewType) {
                                if (0 === s.T.length) return DayPilot.Date.today();
                                var e = s.T.map(function (e) {
                                        return e.start.getTime()
                                    }),
                                    t = Math.min.apply(null, e);
                                return new DayPilot.Date(t)
                            }
                            return this.T[0].start
                        },
                        this.visibleEnd = function () {
                            if ("Resources" === s.viewType) {
                                if (0 === s.T.length) return DayPilot.Date.today().addDays(1);
                                var e = s.T.map(function (e) {
                                        return e.start.getTime()
                                    }),
                            ...
                            var t = this.T.length - 1;
                            return this.T[t].start.addDays(1)
                        },
                        this.u = function (e) {
                            ...
                            if (this.elements.events)
                                for (var e = 0; e < this.elements.events.length; e++) {
                                    var t = this.elements.events[e],
                                        i = t.event;
                                    if (i && (i.calendar = null),
                                        t.onclick = null,
                                        t.onclickSave = null, t.onmouseover = null,
                                        t.onmouseout = null, t.onmousemove = null, t.onmousedown = null,
                        ...
                        this.aa = function (e) {
                            ...
                            a.style.position = "absolute",
                                ...
                                a.style.overflow = "hidden", a.data = e, a.event = e,
                                a.unselectable = "on", a.style.MozUserSelect = "none",
                                a.style.KhtmlUserSelect = "none", a.className = this.u("_event"),
                                i.cssClass && DayPilot.Util.addClass(a, i.cssClass),
                                a.isFirst = e.part.start.getTime() === e.start().getTime(),
                                a.isLast = e.part.end.getTime() === e.end().getTime(), a.onclick = this.P,
                                DayPilot.re(a, "contextmenu", this.R), a.onmouseout = function (e) {
                                ...
                                a.onmousemove = function (i) {
                                    ...
                                    if ("n-resize" !== this.style.cursor && "s-resize" !== this.style.cursor || 1 !== n) {
                                        if (1 === n && e.client.moveEnabled()) {
                                            ...
                                            a.oldColumn = s.T[this.data.part.dayIndex].id, t.originalMouse = DayPilot.mc(i),
                                                t.originalTop = this.offsetTop;
                                            var l = DayPilot.mo3(this, i);
                                            l ? t.moveOffsetY = l.y : t.moveOffsetY = 0, s.nav.top.style.cursor = "move"
                                        }
                                    } else t.resizing = this, t.originalMouse = DayPilot.mc(i),
                                        t.originalHeight = this.offsetHeight, t.originalTop = this.offsetTop, s.nav.top.style.cursor = this.style.cursor;
                                    return !1
                                };
                        ...
                        this.ca = function () {
                            this.nav.top.innerHTML = "", DayPilot.Util.addClass(this.nav.top, this.u("_main")),
                                ...
                                this.nav.scroll.style.height = this.da() + "px",
                                //проклятий скрол
                                "BusinessHours" != /* було ===*/ this.heightSpec ? this.nav.scroll.style.overflow = "auto" : this.nav.scroll.style.overflow = "hidden",
                                this.nav.scroll.style.position = "relative";
                            var e = this.ea();
                            this.nav.top.appendChild(e), this.nav.scroll.style.zoom = 1;
                            var t = this.fa();
                            this.nav.scrollable = t.firstChild, this.nav.scroll.appendChild(t),
                                this.nav.top.appendChild(this.nav.scroll), this.nav.scrollLayer = document.createElement("div"),
                                ...
                                this.nav.loading = document.createElement("div"), this.nav.loading.style.position = "absolute",
                                this.nav.loading.style.top = "0px", this.nav.loading.style.left = this.hourWidth + 5 + "px",
                                this.nav.loading.style.backgroundColor = this.loadingLabelBackColor, this.nav.loading.style.fontSize = this.loadingLabelFontSize,
                                this.nav.loading.style.fontFamily = this.loadingLabelFontFamily, this.nav.loading.style.color = this.loadingLabelFontColor,
                                this.nav.loading.style.padding = "2px", this.nav.loading.innerHTML = this.loadingLabelText, this.nav.loading.style.display = "none",
                        ...
                        this.G = function () {
                            this.fasterDispose || DayPilot.pu(this.nav.hourTable),
                                ...
                                this.nav.hourTable = this.ga(), this.nav.scrollable.rows[0].cells[0].appendChild(this.nav.hourTable)
                        },
                        this.fa = function () {
                            var e = document.createElement("div");
                            e.style.zoom = 1, e.style.position = "relative";
                            var t = document.createElement("table");
                            t.cellSpacing = "0", t.cellPadding = "0", t.border = "0", t.style.border = "0px none",
                                t.style.width = "100%", t.style.position = "absolute";
                            var i, n = t.insertRow(-1);
                            i = n.insertCell(-1), i.valign = "top",
                                i.style.padding = "0px", i.style.border = "0px none", this.nav.hourTable = this.ga(),
                                i.appendChild(this.nav.hourTable), i = n.insertCell(-1), i.valign = "top", i.width = "100%",
                                i.style.padding = "0px", i.style.border = "0px none";
                            var s = document.createElement("div");
                            return s.style.position = "relative", i.appendChild(s),
                                s.appendChild(this.ha()), s.appendChild(this.ia()), e.appendChild(t), this.nav.zoom = e, e
                        },
                        this.ha = function () {
                            var e = document.createElement("table");
                            return e.cellPadding = "0", e.cellSpacing = "0", e.border = "0", e.style.width = "100%",
                                e.style.border = "0px none", e.style.tableLayout = "fixed", this.nav.main = e, this.nav.events = e, e
                        },
                        this.ia = function () {
                            var e = document.createElement("table");
                            e.style.top = "0px", e.cellPadding = "0",
                                e.cellSpacing = "0", e.border = "0", e.style.position = "absolute", e.style.width = "100%",
                                e.style.border = "0px none", e.style.tableLayout = "fixed", this.nav.events = e;
                            for (var t = this.T, i = t.length,
                                    n = e.insertRow(-1), a = 0; a < i; a++) {
                                var l = n.insertCell(-1);
                                l.style.padding = "0px", l.style.border = "0px none", l.style.height = "0px",
                                    l.style.overflow = "visible", s.rtl || (l.style.textAlign = "left");
                                var o = document.createElement("div");
                                o.style.marginRight = s.columnMarginRight + "px", o.style.position = "relative",
                                    o.style.height = "1px", o.style.marginTop = "-1px";
                                var r = document.createElement("div");
                                l.selection = r,
                                    l.appendChild(o), l.appendChild(r)
                            }
                            return e
                        }, this.ga = function () {
                            var e = document.createElement("table");
                            e.cellSpacing = "0", e.cellPadding = "0", e.border = "0",
                                e.style.border = "0px none", e.style.width = this.hourWidth + "px", e.oncontextmenu = function () {
                                    return !1
                                };
                            for (var t = s.J(), i = 0; i < t; i++) this.ja(e, i);
                            return e
                        },
                        this.ja = function (e, t) {
                            ...
                            n.style.height = i + "px";
                            var l = n.insertCell(-1);
                            l.valign = "bottom", l.unselectable = "on",
                                l.style.cursor = "default", l.style.padding = "0px", l.style.border = "0px none";
                            var o = document.createElement("div");
                            o.style.position = "relative", o.className = this.u("_rowheader"), o.style.width = this.hourWidth + "px", o.style.height = i + "px",
                                o.style.overflow = "hidden", o.unselectable = "on";
                            var r = document.createElement("div");
                            ...
                            var f;
                            f = "Clock12Hours" === v ? u ? "AM" : "PM" : "00", p.innerHTML = f,
                                h.appendChild(p), r.appendChild(h), o.appendChild(r), l.appendChild(o)
                        },
                        this.da = function () {
                        ...
                        this.ea = function () {
                            ...
                            var t = document.createElement("table");
                            t.cellPadding = "0", t.cellSpacing = "0", t.border = "0",
                                t.style.width = "100%", t.style.borderCollapse = "separate", t.style.border = "0px none";
                            var i = t.insertRow(-1),
                                n = i.insertCell(-1);
                            n.style.padding = "0px", n.style.border = "0px none";
                            var s = this.la();
                            n.appendChild(s), this.nav.corner = s, n = i.insertCell(-1), n.style.width = "100%",
                                n.valign = "top", n.style.position = "relative", n.style.padding = "0px", n.style.border = "0px none",
                                this.nav.header = document.createElement("table"), this.nav.header.cellPadding = "0",
                                this.nav.header.cellSpacing = "0", this.nav.header.border = "0", this.nav.header.width = "100%",
                                this.nav.header.style.tableLayout = "fixed", this.nav.header.oncontextmenu = function () {
                                    return !1
                                };
                            ...
                            if (n.appendChild(this.nav.header), a) {
                                ...
                                var l = document.createElement("div");
                                l.unselectable = "on", l.style.position = "relative",
                                    l.style.width = "16px", l.style.height = this.headerHeight + "px",
                                    l.className = this.u("_cornerright");
                                var o = document.createElement("div");
                        ...
                        this.la = function () {
                            ...
                            e.style.position = "relative",
                                ...
                                e.style.width = this.hourWidth + "px", e.style.height = this.headerHeight + "px", e.oncontextmenu = function () {
                                    return !1
                                };
                            var t = document.createElement("div");
                        ...
                        this.F = function () {
                            ...
                            this.tableCreated = !0;
                            for (var l = a.length,
                                    o = this.nav.events; o && o.rows && o.rows.length > 0;)
                            ...
                            for (var l = a.length, r = o.insertRow(-1), h = 0; h < l; h++) {
                                ...
                                c.style.padding = "0px", c.style.border = "0px none",
                                    c.style.height = "0px", c.style.overflow = "visible", s.rtl || (c.style.textAlign = "left");
                                var d = document.createElement("div");
                                d.style.marginRight = s.columnMarginRight + "px",
                                    d.style.position = "relative", d.style.height = "1px", d.style.marginTop = "-1px";
                                var u = document.createElement("div");
                            ...
                            for (var v = 0; v < n; v++) {
                                ...
                                for (var h = 0; h < l; h++) {
                                    ...
                                    c.start = p.start.addTime(v * i),
                                        c.end = c.start.addTime(i), c.resource = p.id, c.onmousedown = this.U,
                                        c.onmouseup = function () {
                                            return !1
                                        }, c.onclick = function () {
                                            return !1
                                        },
                                        c.root = this, c.style.padding = "0px", c.style.border = "0px none", c.style.verticalAlign = "top",
                                        c.style.height = s.cellHeight + "px", c.style.overflow = "hidden", c.unselectable = "on";
                                    var d = document.createElement("div");
                                    d.unselectable = "on",
                                        d.style.height = s.cellHeight + "px", d.style.position = "relative",
                                        d.className = this.u("_cell");
                                    this.ma(c.start, c.end) && DayPilot.Util.addClass(d, s.u("_cell_business"));
                                    var f = document.createElement("div");
                                    f.setAttribute("unselectable", "on"),
                                        f.className = this.u("_cell_inner"), d.appendChild(f), c.appendChild(d), c.appendChild(d)
                                }
                            }
                            e.root = this, s.nav.scrollable.onmousemove = function (e) {
                                ...
                                if (t.resizing) {
                                    ...
                                    if (t.movingShadow || (t.movingShadow = s.t(t.moving, !s.g, s.shadow),
                                            t.movingShadow.style.width = t.movingShadow.parentNode.offsetWidth + 1 + "px"), !s.coords) return;
                                    var a = s.cellHeight,
                                        l = 1,
                                        d = t.moveOffsetY;
                                    d || (d = a / 2);
                                    ...
                                    c + v > h && (c = h - v), t.movingShadow.parentNode.style.display = "none", t.movingShadow.style.top = c + "px",
                                        t.movingShadow.parentNode.style.display = "";
                                    var p = u.clientWidth / u.rows[0].cells.length,
                                        f = Math.floor((s.coords.x - 45) / p);
                                    f < 0 && (f = 0), f < u.rows[0].cells.length && f >= 0 && t.movingShadow.column !== f && (t.movingShadow.column = f,
                                    ...
                                    n.y < t.firstMousePos.y ? (t.selectedCells = t.getCellsBelow(y),
                                        t.topSelectedCell = t.selectedCells[0], t.bottomSelectedCell = t.firstSelected) : (t.selectedCells = t.getCellsAbove(y),
                                        t.topSelectedCell = t.firstSelected, t.bottomSelectedCell = t.selectedCells[0]), s.V()
                                }
                        ...
                        this.na = function (e) {
                            for (var t = e ? this.nav.header.insertRow(-1) : this.nav.header.rows[0], i = this.T, n = i.length, a = 0; a < n; a++) {
                                var l = i[a],
                            ...
                            if ("Disabled" !== s.headerClickHandling) {
                                ...
                                n.header = {}, n.header.id = t.id,
                                    n.header.name = t.name, n.header.start = t.start, n.column = i, n.originalEvent = e,
                                    n.shift = e.shiftKey, n.ctrl = e.ctrlKey, n.meta = e.metaKey, n.preventDefault = function () {
                                        this.preventDefault.value = !0
                        ...
                        this.sa = function () {
                            ...
                            var t = "undefined" != typeof this.ua.scrollpos ? this.ua.scrollpos : this.initScrollPos;
                        ...
                        this.update = function (e) {
                            if (s.xa(e), this.Z) {
                                ...
                                s.B(), s.E(), s.F(), s.G(), s.H(), s.ka(), s.za(), s.C(), s.D(), s.A(), s.I(), s.clearSelection(),
                                    this.visible ? this.show() : this.hide()
                            }
                        }, this.Aa = null, this.xa = function (e) {
                            if (e) {
                                var t = {
                                    "events": {
                                        "preInit": function () {
                        ...
                        this.Da = {}, this.Da.events = [],
                        this.Ea = function (e) {
                            var t = this.Da.events,
                                        ...
                                        if (!n[v]) {
                                            ...
                                            if (!(m < g)) {
                                                ...
                                                if ("Resources" === s.viewType && (y = y && r.id === l.resource), y) {
                                                    ...
                                                    b.part.dayIndex = a,
                                                        b.part.start = c < g ? l.start : h, b.part.end = u > m ? l.end : d;
                                                    ...
                                                    p > o.maxStart && (o.maxStart = p),
                                                        f < o.minEnd && (o.minEnd = f), p < this.minStart && (this.minStart = p),
                                                        f > this.maxEnd && (this.maxEnd = f), r.events.push(b),
                                                        "function" == typeof this.onBeforeEventRender && (b.cache = this.Da.events[v]),
                        ...
                        this.debug = function (e, t) {
                            ...
                            0 === o && (h = r);
                            var c = {};
                            return c.cut = !1, c.top = this.Ga(l), c.boxTop = this.Ga(r), c.boxBottom = this.Ga(h), this.cache.pixels[n + "_" + i] = c, c
                        },
                        this.Ga = function (e) {
                        ...
                        this.za = function () {
                            var e = 0;
                            s.ua.scrollHour ? e = 2 * s.cellHeight * s.ua.scrollHour : "Auto" === s.initScrollPos && (e = "BusinessHours" === this.heightSpec ? 2 * this.cellHeight * this.businessBeginsHour : 0),
                            ...
                            this.ya(), this.B(), this.ca(), this.E(), this.F(), this.va(), this.sa(), this.wa(), t.register(this), this.Ja(), this.m("Init")
                        }, this.ua = {}, this.Ka = function () {
                            this.ua.themes = [], this.ua.themes.push(this.theme || this.cssClassPrefix)
                        }, this.La = function () {
                            for (var e = this.ua.themes, t = 0; t < e.length; t++) {
                                var i = e[t];
                            ...
                            if ("function" == typeof this.onInit && !this.Oa) {
                                this.Oa = !0;
                                var e = {};
                                this.onInit(e)
                            }
                            ...
                            var e = s.Pa;
                            e() || (s.Qa = setInterval(function () {
                                e() && (s.sa(), s.va(), clearInterval(s.Qa))
                            }, 100))
                        ...
                        }, this.internal = {}, this.internal.loadOptions = s.xa, this.internal.xssTextHtml = s.pa, this.init = function () {
                            this.Ca();
                            var e = this.Ha();
                            return this.Ka(), e ? void this.Ia() : (this.ya(), this.B(), this.C(), this.ca(), this.E(), this.F(), this.A(), this.va(), this.sa(), this.wa(), t.register(this), this.events && (this.D(), this.I()), this.Ma(), this.Na(), this.Ja(), this.Z = !0, this)
                        }, this.Init = this.init, this.xa(i)
                },
                DayPilot.CalendarColumn = function (e, t) {
                    var i = this;
                    i.id = e.id, i.name = e.name, i.data = e.data,
                        i.start = new DayPilot.Date(e.start), i.calendar = t, i.toJSON = function () {
                            var e = {};
...
! function () {
    "undefined" != typeof DayPilot.DatePicker && DayPilot.DatePicker.close || (DayPilot.DatePicker = function (t) {
        ...
        var e = "navigator_" + (new Date).getTime(),
            i = this;
        this.onShow = null, this.onTimeRangeSelect = null,
            this.onTimeRangeSelected = null, this.prepare = function () {
                if (this.locale = "en-us",
                    this.target = null, this.targetAlignment = "left", this.resetTarget = !0,
                    this.pattern = this.a.locale().datePattern, this.theme = "navigator_default", this.patterns = [],
                    this.zIndex = null, t)
            ...
            this.close = function () {
                this.e && (this.e = !1, this.navigator && this.navigator.dispose(),
                    this.div.innerHTML = "", this.div && this.div.parentNode === document.body && document.body.removeChild(this.div))
                ...
                if (!this.e) {
                    ...
                    n.api = 2, n.cssOnly = !0,
                        n.theme = i.theme, n.weekStarts = "Auto", n.locale = i.locale, n.onTimeRangeSelected = function (t) {
                            i.date = t.start;
                    ...
                    r.style.position = "absolute", "left" === s && (r.style.left = a.x + "px"),
                        r.style.top = a.y + o + "px", i.zIndex && (r.style.zIndex = i.zIndex);
                    var l = document.createElement("div");
...
"undefined" == typeof DayPilot.Global && (DayPilot.Global = {}),
    function (DayPilot) {
        ...
        if ("undefined" == typeof DayPilot.Menu || !DayPilot.Menu.def) {
            var e = function () {},
                n = {};
            n.mouse = null, n.menu = null, n.handlersRegistered = !1, n.hideTimeout = null,
                n.waitingSubmenu = null, DayPilot.Menu = function (t) {
                    var i = this,
                        o = null;
                    this.v = "2022.3.415-lite", this.zIndex = 120, this.cssClassPrefix = "menu_default", this.cssOnly = !0,
                        this.menuTitle = null, this.showMenuTitle = !1, this.hideOnMouseOut = !1, this.hideAfter = 200,
                        this.theme = null, this.onShow = null, this.b = function () {},
                        t && DayPilot.isArray(t) && (this.items = t), this.toJSON = function () {
                            return null
                        },
                        this.show = function (t, a) {
                            a = a || {};
                            var u = null;
                            if (t ? "string" == typeof t.id || "number" == typeof t.id ? u = t.id : "function" == typeof t.id ? u = t.id() : "function" == typeof t.value && (u = t.value()) : u = null, "undefined" != typeof DayPilot.Bubble && DayPilot.Bubble.hideActive(), a.submenu || n.menuClean(),
                                this.b.submenu = null, null !== n.mouse) {
                                ...
                                if (c.style.position = "absolute", c.style.top = "0px", c.style.left = "0px", c.style.display = "none",
                                    c.style.overflow = "hidden", c.style.zIndex = this.zIndex + 1, c.className = this.applyCssClass("main"),
                                ...
                                for (var d = 0; d < this.items.length; d++) {
                                    ...
                                    if (DayPilot.Util.addClass(f, this.applyCssClass("item")), m.items && DayPilot.Util.addClass(f, this.applyCssClass("item_haschildren")), "undefined" != typeof m && !m.hidden) {
                                        if ("-" === m.text) {
                                            ...
                                            if (v.style.position = "relative", v.style.display = "block",
                                                m.cssClass && DayPilot.Util.addClass(v, m.cssClass),
                                                m.disabled) DayPilot.Util.addClass(v, i.applyCssClass("item_disabled"));
                                            else {
                                                if (m.onclick || m.onClick) {
                                                    v.item = m, v.onclick = function (e, n) {
                                                        return function (t) {
                                                            if ("function" == typeof e.onClick) {
                                                                var i = {};
                                                                if (i.item = e, i.source = n.source, i.originalEvent = t, i.preventDefault = function () {
                                                                        i.preventDefault.value = !0
                                                                    }, e.onClick(i), i.preventDefault.value) return
                                                            }
                                                            e.onclick && e.onclick.call(n, t)
                                                        }
                                                    }(m, v);
                                                    var p = function (e, t) {
                                                        return function (i) {
                                                            ...
                                                            var o = function () {
                                                                window.setTimeout(function () {
                                                                    t.source.calendar.internal.touch.active = !1
                                                                }, 500)
                                                            };
                                                            if ("function" == typeof e.onClick) {
                                                                var a = {};
                                                                if (a.item = e, a.source = t.source, a.originalEvent = i, a.preventDefault = function () {
                                                                    ...
                                                                    }, e.onClick(a), a.preventDefault.value) return void o()
                                                            }
                                                ...
                                                if (m.items && !m.disabled) {
                                                    var b = function (e, n) {
                                                        return function (t) {
                                                            t.preventDefault(), t.stopPropagation(), i.c(e, n)
                                                        }
                                                    };
                                                    v.ontouchend = b(m, v)
                                                }
                                                if (m.onclick) e();
                                                else if (m.href) v.href = m.href.replace(/\x7B0\x7D/gim, u), m.target && v.setAttribute("target", m.target);
                                                else if (m.command) {
                                                    var b = function (e, n) {
                                                        return function (t) {
                                                            var i = n.source,
                                                            ...
                                                            var a = i.calendar || i.root;
                                                            if (i instanceof DayPilot.Link)
                                                                return void a.internal.linkMenuClick(o.command, i, o.action);
                                                            if (i instanceof DayPilot.Selection)
                                                                return void a.internal.timeRangeMenuClick(o.command, i, o.action);
                                                            if (i instanceof DayPilot.Event)
                                                                return void a.internal.eventMenuClick(o.command, i, o.action);
                                                            if (i instanceof DayPilot.Selection)
                                                                return void a.internal.timeRangeMenuClick(o.command, i, o.action);
                                                            if (i instanceof DayPilot.Task)
                                                                return void("resource" === i.menuType ? a.internal.resourceHeaderMenuClick(o.command, n.menuSource, o.action) : a.internal.eventMenuClick(o.command, n.menuSource, o.action));
                                                            switch (i.menuType) {
                                                                case "resource":
                                                                    return void a.internal.resourceHeaderMenuClick(o.command, i, o.action);
                                                                case "selection":
                                                                    return void a.internal.timeRangeMenuClick(o.command, i, o.action);
                                                                default:
                                                                    return void a.internal.eventMenuClick(o.command, i, o.action)
                                            ...
                                            if (y.className = i.applyCssClass("item_text"), y.innerHTML = DayPilot.Util.escapeTextHtml(m.text, m.html), v.appendChild(y), m.image) {
                                                ...
                                                C.src = m.image, C.style.position = "absolute", C.style.top = "0px",
                                                    C.style.left = "0px", v.appendChild(C)
                                            }
                                            if (m.icon) {
                                            ...
                                            var M = function (e, t) {
                                                return function () {
                                                    var o = (t.source, e),
                                                        a = n.waitingSubmenu;
                                                    if (a) {
                                                        if (a.parent === o) return;
                                                        clearTimeout(a.timeout), n.waitingSubmenu = null
                                                    }
                                                    e.disabled || (n.waitingSubmenu = {}, n.waitingSubmenu.parent = o, n.waitingSubmenu.timeout = setTimeout(function () {
                                                        n.waitingSubmenu = null, i.c(o, t)
                                                    }, 300))
                                                }
                                            };
                                ...
                                var k = function (e) {
                                    window.setTimeout(function () {
                                        n.menuClean(), DayPilot.MenuBar.deactivate()
                                    }, 100)
                                };
                                c.onclick = k, c.ontouchend = k, c.onmousedown = function (e) {
                                    e = e || window.event, e.cancelBubble = !0, e.stopPropagation && e.stopPropagation()
                                }, c.oncontextmenu = function () {
                                    return !1
                                }, document.body.appendChild(c), i.b.visible = !0, i.b.source = t, c.style.display = "";
                                var x = c.offsetHeight,
                                    T = c.offsetWidth;
                                c.style.display = "none";
                                var P = document.documentElement.clientHeight,
                                    E = window.innerWidth,
                                    S = "number" == typeof a.windowMargin ? a.windowMargin : 5;
                                if (function () {
                                        var e = a.initiator;
                                        if (e) {
                                            var n = e.div,
                                        ...
                                        var e = "number" == typeof a.x ? a.x : n.mouse.x + 1,
                                            t = "number" == typeof a.y ? a.y : n.mouse.y + 1,
                                        ...
                                        if (t - i > P - x && 0 !== P) {
                                            var u = t - i - (P - x) + S;
                                            c.style.top = t - u + "px"
                                        } else c.style.top = t + "px";
                                        if ("right" === a.align && (e -= T), e - o > E - T && 0 !== E) {
                                            var s = e - o - (E - T) + S;
                                            c.style.left = e - s + "px"
                                        } else c.style.left = e + "px"
                                    }(), a.parentLink) {
                                    var D = a.parentLink,
                                        N = parseInt(new DayPilot.StyleReader(c).get("border-top-width")),
                                        B = DayPilot.abs(a.parentLink.parentNode),
                                        H = B.x + D.offsetWidth,
                                        L = B.y - N;
                            ...
                            var t = e,
                                o = n.source;
                            if ((!i.b.submenu || i.b.submenu.item !== e) && (i.b.submenu && i.b.submenu.item !== e && (DayPilot.Util.removeClass(i.b.submenu.link.parentNode, i.applyCssClass("item_haschildren_active")), i.b.submenu.menu.hide(), i.b.submenu = null), e.items)) {
                                var a = i.cloneOptions();
                                a.items = e.items, i.b.submenu = {},
                                    i.b.submenu.menu = new DayPilot.Menu(a), i.b.submenu.menu.d = i,
                                    i.b.submenu.menu.show(o, {
                                        "submenu": !0,
                                        "parentLink": n,
                                        "parentItem": t
                                    }), i.b.submenu.item = e,
                                    i.b.submenu.link = n, DayPilot.Util.addClass(n.parentNode, i.applyCssClass("item_haschildren_active"))
                            }
                        },
                        this.applyCssClass = function (e) {
                            var n = this.theme || this.cssClassPrefix,
                                t = this.cssOnly ? "_" : "";
                            return n ? n + t + e : ""
                        },
                        this.cloneOptions = function () {
                            return DayPilot.Util.copyProps(a, {}, ["cssClassPrefix", "theme", "hideAfter", "hideOnMouseOut", "zIndex"])
                        },
                        this.hide = function (e) {
                            e = e || {}, this.b.submenu && this.b.submenu.menu.hide();
                            var t = n.waitingSubmenu;
                            if (t && (n.waitingSubmenu = null, clearTimeout(t.timeout)), this.removeShadow(), this.b.div && this.b.div.parentNode === document.body && document.body.removeChild(this.b.div), o && (DayPilot.de(o), o = null), i.b.visible = !1, i.b.source = null, i.d && e.hideParent && i.d.hide(e), DayPilot.Menu.active === i && (DayPilot.Menu.active = null), "function" == typeof this.onHide) {
                                var a = {};
                                this.onHide(a)
                            }
                        },
                        ...
                        this.cancelHideTimeout = function () {
                            ...
                            return n.mouseMove(e), this
                        }, this.addShadow = function (e) {},
                        this.removeShadow = function () {};
                    var a = DayPilot.isArray(t) ? null : t;
                    if (a)
                        for (var u in a) this[u] = a[u]
                },
                DayPilot.MenuBar = function (e, n) {
                    var t = this;
                    n = n || {}, this.items = [], this.theme = "menubar_default",
                        this.windowMargin = 0, this.nav = {}, this.elements = {}, this.elements.items = DayPilot.list(),
                        this.f = null, this.g = !1;
                    ...
                    this.i = function (e) {
                        ...
                        var n = this.nav.top;
                        n.className = this.i("main"), DayPilot.list(t.items).forEach(function (e) {
                            var i = document.createElement("span");
                            i.innerHTML = DayPilot.Util.escapeTextHtml(e.text, e.html), i.className = t.i("item"),
                                e.cssClass && i.classList.add(e.cssClass), i.data = e, i.onclick = function (n) {
                                    if (t.active && t.active.item === e) t.k();
                                    else if (e.children) return void t.l(i);
                                    if ("function" == typeof e.onClick) {
                                        var o = {};
                                    ...
                                    t.active && t.active.item !== e && t.l(i)
                                }, n.appendChild(i), t.elements.items.push(i)
                        })
                    }, this.k = function () {
                        var e = t.i("item_active");
                        t.elements.items.forEach(function (n) {
                            DayPilot.Util.removeClass(n, e)
                        }), t.active && t.active.menu && t.active.menu.hide(), t.active = null
                    }, this.m = function (e) {
                        return !!t.active && t.active.item === e.data
                    }, this.l = function (e) {
                        if (!t.m(e)) {
                            t.k();
                            var n = e.data,
                        ...
                        return this.j(), this.g = !0, this
                    }, this.dispose = function () {
                        this.g && (this.nav.top.innerHTML = "", this.elements.items = [])
                    }
                }, DayPilot.MenuBar.deactivate = function () {
                    DayPilot.MenuBar.active && (DayPilot.MenuBar.active.k(), DayPilot.MenuBar.active = null)
                }, n.menuClean = function () {
                    ...
                    "undefined" != typeof n && (n.menuClean(), DayPilot.MenuBar.deactivate())
                }, n.mouseMove = function (e) {
                    "undefined" != typeof n && (n.mouse = n.mousePosition(e))
                }, n.touchMove = function (e) {
                    "undefined" != typeof n && (n.mouse = n.touchPosition(e))
                }, n.touchStart = function (e) {
                    "undefined" != typeof n && (n.mouse = n.touchPosition(e))
                }, n.touchEnd = function (e) {},
                n.touchPosition = function (e) {
                    if (!e || !e.touches) return null;
                    var n = e.touches[0],
                        t = {};
                    return t.x = n.pageX, t.y = n.pageY, t
                }, n.mousePosition = function (e) {
                    return DayPilot.mo3(null, e)
                }, DayPilot.Menu.touchPosition = function (e) {
                    e.touches && (n.mouse = n.touchPosition(e))
                ...
                }, n.handlersRegistered || (DayPilot.re(document, "mousemove", n.mouseMove),
                    DayPilot.re(document, "mousedown", n.mouseDown), DayPilot.re(document, "touchmove", n.touchMove),
                    DayPilot.re(document, "touchstart", n.touchStart), DayPilot.re(document, "touchend", n.touchEnd), n.handlersRegistered = !0),
                DayPilot.Menu.def = {}
        }
    }(DayPilot);
        ...
        if (!DayPilot.ModalStatic) {
            ...
            var a = function () {
                    ...
                    e.setAttribute("type", "text/css"),
                        e.styleSheet || e.appendChild(document.createTextNode("")), (document.head || document.getElementsByTagName("head")[0]).appendChild(e);
                    var t = !!e.styleSheet,
                        a = {};
                    return a.rules = [], a.commit = function () {
                        try {
            ...
            n.add(".modal_default_main", "border: 10px solid #ccc; max-width: 90%;"),
                ...
                n.add(".modal_default_form_item_searchable_icon:after",
                    "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + i + ");"),
                ...
                n.add(".modal_default_form_item_time_icon:after",
                    "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + i + ");"),
                ...
                n.add(".modal_default_form_item_tabular_table input[type=text], .modal_default_form_item_tabular_table input[type=number]",
                    "width:100%; box-sizing: border-box;"),
                n.add(".modal_default_form_item_tabular_table select", "width:100%; height:100%; box-sizing: border-box;"),
                n.add(".modal_default_form_item_tabular_plus",
                ...
                n.add(".modal_default_form_item_tabular_plus:after",
                ...
                n.add(".modal_default_form_item_tabular_delete",
                    "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"),
                n.add(".modal_default_form_item_tabular_delete:after",
                ...
                n.add(".navigator_modal_title, .navigator_modal_titleleft, .navigator_modal_titleright",
                ...
                n.commit(), DayPilot.Modal = function (e) {
                    this.autoFocus = !0, this.focus = null, this.autoStretch = !0, this.autoStretchFirstLoadOnly = !1,
                        ...
                        this.locale = null, this.closed = null, this.onClose = null, this.onClosed = null,
                        this.onShow = null;
                    var t = this;
                    this.id = "_" + (new Date).getTime() + "n" + 10 * Math.random(),
                        this.a = !1, this.b = null, this.c = null,
                        this.showHtml = function (e) {
                            ...
                            if (this.useIframe) {
                                ...
                                a && (this.iframe.src = "about:blank", this.setInnerHTML(this.id + "iframe", a)),
                                    this.re(this.iframe, "load", this.h), this.iframe.src = e, this.e(), this.f(), this.g()
                            } else t.i({
                                "url": e,
                                "success": function (e) {
                            ...
                            if (t) {
                                var a = e.method || "GET",
                                    ...
                                    l = e.url;
                                t.open(a, l, !0),
                                    t.setRequestHeader("Content-type", "text/plain"), t.onreadystatechange = function () {
                                        if (4 === t.readyState)
                            ...
                            this.theme && (this.hideDiv.className = this.theme + "_background"),
                                ...
                                this.div.style.boxSizing = "content-box", this.div.style.top = i + this.top + "px", this.div.style.width = this.width + "px",
                                ...
                                this.div.style.display = "", this.l(), DayPilot.ModalStatic.remove(this), DayPilot.ModalStatic.list.push(this)
                        }, this.h = function () {
                            ...
                            if (this.useIframe) {
                                for (var i = a() - 40, n = this.width; n < i && this.m(); n += 10) this.div.style.width = n + "px",
                                    this.div.style.marginLeft = "-" + Math.floor(n / 2) + "px";
                            ...
                            for (var e = this.iframe.contentWindow.document,
                                    t = "BackCompat" === e.compatMode ? e.body : e.documentElement, a = t.scrollWidth,
                                    i = e.body.children, n = 0; n < i.length; n++) {
                                var o = i[n].offsetLeft + i[n].offsetWidth;
                                a = Math.max(a, o)
                            }
                            return a > t.clientWidth
                        }, this.n = function () {
                            for (var e = this.iframe.contentWindow.document, t = "BackCompat" === e.compatMode ? e.body : e.documentElement,
                                    a = t.scrollHeight, i = e.body.children, n = 0; n < i.length; n++) {
                            ...
                            this.a || (this.re(window, "resize", this.o), this.re(window, "scroll", this.p),
                                this.dragDrop && (this.re(document, "mousemove", this.q), this.re(document, "mouseup", this.r)), this.a = !0)
                        }, this.s = function () {
                            this.ue(window, "resize", this.o), this.ue(window, "scroll", this.p),
                                this.dragDrop && (this.ue(document, "mousemove", this.q), this.ue(document, "mouseup", this.r)), this.a = !1
                        }, this.t = function (e) {
                            e.target === t.div && (e.preventDefault(), t.div.style.cursor = "move", t.u(),
                                t.c = t.mc(e || window.event), t.b = {
                                    x: t.div.offsetLeft,
                                    y: t.div.offsetTop
                                })
                        }, this.q = function (e) {
                            if (t.c) {
                                ...
                                t.div.style.marginLeft = "0px",
                                    t.div.style.top = t.b.y + n + "px", t.div.style.left = t.b.x + i + "px"
                            }
                        }, this.r = function (e) {
                            ...
                            if (this.useIframe) {
                                ...
                                e.style.backgroundColor = "#ffffff",
                                    e.style.filter = "alpha(opacity=80)", e.style.opacity = "0.80", e.style.width = "100%",
                                    e.style.height = this.height + "px", e.style.position = "absolute", e.style.left = "0px", e.style.top = "0px",
                                    this.div.appendChild(e), this.mask = e
                            }
                        }, this.v = function () {
                        ...
                        this.d = function () {
                            ...
                            n.id = this.id + "hide", n.style.position = i, n.style.left = "0px",
                                n.style.top = "0px", n.style.right = "0px", n.style.bottom = "0px", n.oncontextmenu = function () {
                                    return !1
                                }, n.onmousedown = function () {
                                    return !1
                                }, e.appendChild(n);
                            var o = document.createElement("div");
                            o.id = this.id + "popup", o.style.position = i, o.style.left = "50%", o.style.top = "0px",
                                o.style.backgroundColor = "white", o.style.width = "50px", o.style.height = "50px",
                                this.dragDrop && (o.onmousedown = this.t), o.addEventListener("keydown", function (e) {
                                    e.stopPropagation()
                                });
                            var l = null;
                            this.useIframe && (l = document.createElement("iframe"), l.id = this.id + "iframe",
                                    l.name = this.id + "iframe", l.frameBorder = "0", l.style.width = "100%", l.style.height = "50px", o.appendChild(l)),
                                e.appendChild(o), this.div = o, this.iframe = l, this.hideDiv = n
                        }, this.setInnerHTML = function (e, a) {
                            var i = window.frames[e],
                                n = i.contentWindow || i.document || i.contentDocument;
                            n.document && (n = n.document),
                                null == n.body && n.write("<body></body>"), a.nodeType ? n.body.appendChild(a) : n.body.innerHTML = a,
                            ...
                            e = e || {};
                            var a = {};
                            a.backgroundClick = !!e.backgroundClick, a.result = this.result, a.canceled = "undefined" == typeof
                            this.result, a.preventDefault = function () {
                                this.preventDefault.value = !0
                            }, "function" == typeof this.onClose && (this.onClose(a), a.preventDefault.value) || (this.div && (this.div.style.display = "none", this.hideDiv.style.display = "none", this.useIframe || (this.div.innerHTML = null)),
                                window.focus(), DayPilot.ModalStatic.remove(this),
                                "function" == typeof this.onClosed ? this.onClosed(a) : this.closed && this.closed(), delete this.result,
                    ...
                    return DayPilot.getPromise(function (n, o) {
                        ...
                        m.innerText = i,
                            m.className = l.theme + "_cancel", m.onclick = function (e) {
                    ...
                    return DayPilot.getPromise(function (t, l) {
                        ...
                        f.innerText = n, f.className = d.theme + "_cancel", f.onclick = function (e) {
                                d.close()
                            }, m.appendChild(h), m.appendChild(p), m.appendChild(f), r.appendChild(s), r.appendChild(c), r.appendChild(m), d.showHtml(r),
                            d.autoFocus && u.focus()
                    })
                };
            var o = function (e) {
            ...
            DayPilot.Modal.form = function (t, a, i) {
                    ...
                    return DayPilot.getPromise(function (i, n) {
                        ...
                        f.innerText = c, f.className = o.theme + "_ok", s.okDisabled && (f.disabled = !0),
                        ...
                        if (g.innerText = u, g.className = o.theme + "_cancel", g.onclick = function (e) {
                                ...
                                m.canceling = !0
                            }, p.appendChild(f), p.appendChild(v), p.appendChild(g), d.appendChild(r), d.appendChild(p), o.showHtml(d),
                            o.div.setAttribute("tabindex", "-1"), o.div.addEventListener("keydown", function (e) {
                                switch (e.keyCode) {
                                    case 27:
                                        o.close();
                                        break;
                ...
                }, DayPilot.Modal.Experimental = {}, DayPilot.Modal.Experimental.Form = l,
            ...
            var l = function (e) {
                this.form = [], this.data = {}, this.theme = "form_default", this.zIndex = 99999,
                    this.locale = "en-us", this.plugins = {}, this.onKey = null, this.D = [], this.E = null, this.canceling = !1,
                    this.F = [], this.G = [], this.H = null, e = e || {};
                for (var t in e) this[t] = e[t]
            };
            l.prototype.create = function () {
                ...
                if (i.className = t + "_form_item " + t + "_form_item_level" + e.level,
                    ...
                    e.data.cssClass && (i.className += " " + e.data.cssClass), !e.isValue) {
                    var n = document.createElement("div");
                ...
                o.onInput = function (e) {
                        ...
                        a.canceling || a.I(o)
                    }, o.apply(e), o.H = i, o.row = e, o.element && i.appendChild(o.element),
                    this.G.push(o), this.H.appendChild(i)
                ...
                if ("radio" === i) {
                    if (e.name) {
                        var o = new d;
                        o.field = e.id, o.data = e, o.level = t, o.type = "label", o.interactive = !1,
                            o.text = e.name, a.D.push(o), n.push(o)
                    }
                    e.options.forEach(function (o) {
                        var l = new d;
                        l.field = e.id, l.data = o, l.level = t, l.type = i, l.isValue = !0,
                            l.text = o.name, l.resolved = o.id, a.D.push(l), n.push(l), o.children && o.children.forEach(function (e) {
                    ...
                    var o = new d;
                    o.isValue = !0, o.field = e.id, o.data = e, o.level = t, o.type = i,
                        o.interactive = !1, o.text = null, a.D.push(o), n.push(o)
                } else if ("html" === i) {
                    var o = new d;
                    o.isValue = !0, o.field = e.id, o.data = e, o.level = t, o.type = i, o.interactive = !1,
                        o.text = null, a.D.push(o), n.push(o)
                ...
                var t = this,
                    a = {
                        ...
                        "scrollable": function () {
                            ...
                            var n = document.createElement("div");
                            return n.className = t.theme + "_form_item_scrollable_scroll_content", "string" == typeof e.data.text ? n.innerText = e.data.text : "string" == typeof e.data.html && (n.innerHTML = e.data.html),
                                i.appendChild(n), a.element = i, a
                        },
                        "text": function () {
                            var a = new r;
                            a.apply = function (e) {
                        ...
                        "radio": function () {
                            ...
                            n.type = "radio",
                                n.name = e.field, n.M = e.resolved, n.onchange = function (e) {
                                    var i = a.row;
                ...
                for (var o = 60 / n, l = e.data.locale || t.locale, d = DayPilot.Locale.find(l) || DayPilot.Locale.US,
                        c = DayPilot.Date.today(), u = 0; u < 24 * o; u++) {
                ...
                return o.className = t.theme + "_form_item_datetime_parent", o.appendChild(i),
                    o.appendChild(n), a.element = o, a.canFocus = function () {
                        return !a.searchable.disabled
                    }, a.focus = function () {
                        a.dateInput.focus()
                    }, a.save = function () {
                ...
                return ["text", "date", "select", "searchable", "radio", "checkbox", "table", "title", "image", "html", "textarea", "scrollable",
                        "time", "datetime"
                    ].indexOf(e.type) !== -1 ? e.type : e.type && this.plugins && this.plugins[e.type] ? e.type : e.image ? "image" : e.html ||
                    e.text ? "html" : e.id ? e.options ? "searchable" : e.dateFormat ? "date" : e.columns ? "table" : "text" : "title"
            ...
            var d = function () {
                this.id = this.guid(), this.field = null, this.data = null, this.type = null, this.level = 0, this.enabled = !0, this.value = null,
                    this.text = null, this.interactive = !0, this.isValue = !1, this.checked = !1, this.resolved = null
            };
            ...
            var r = function () {
                ...
                s = function (e) {
                    this.data = [], this.name = null, this.theme = "searchable_default", this.N = !1, this.listZIndex = 1e5,
                        this.onSelect = null, this.O = null, this.P = null, this.Q = !1, this.R = null, this.S = null, this.T = [],
                        this.U = null, e = e || {};
                    var t = this,
                        a = {
                            "selected": {
                                post: function (e) {
                                    "object" == typeof e && e.id ? t.O = e : "string" != typeof e && "number" != typeof e ||
                                        t.select(e)
                                }
                            }
                        };
            ...
            s.prototype.select = function (e) {
                    ...
                    function e(e) {
                        var a = r.strategy;
                        "includes" !== r.strategy && "startsWith" !== r.strategy && (a = "includes"), e = e || a ||
                            "includes", m.style.display = "", m.style.top = p.offsetHeight + "px", m.style.left = "0px",
                            m.style.width = p.offsetWidth + "px", m.innerHTML = "", m.addEventListener("mousedown", function (e) {
                                e.preventDefault()
                            }), r.P = null, r.T = [];
                        var n = null;
                        r.data.forEach(function (a) {
                            ...
                            var l = document.createElement("div");
                            l.className = r.theme + "_list_item", l.innerText = o,
                                l.item = a, a === r.O && (r.P = l), n || (n = l), l.addEventListener("mousedown", function (e) {
                                    i(l),
                                        e.preventDefault()
                    ...
                    var u = document.createElement("div");
                    u.className = this.theme + "_icon", u.style.position = "absolute", u.style.right = "0",
                        u.style.top = "0", u.style.bottom = "0", u.style.width = "20px", u.addEventListener("mousedown", function (e) {
                            e.preventDefault(), r.Q ? (r.focus(), d()) : (n(), l())
                        });
                    var m = document.createElement("div");
                    m.className = this.theme + "_list", m.style.display = "none",
                        m.style.position = "absolute", m.style.zIndex = this.listZIndex;
                    var h = document.createElement("input");
                    h.type = "hidden", h.name = this.name, h.searchable = s, this.U = h;
                    var p = document.createElement("input");
                    return p.type = "text", p.className = this.theme + "_input",
                        p.disabled = this.N, p.addEventListener("click", function (e) {
                            d()
                            ...
                            if ("ArrowDown" === e.key) {
                                ...
                                var a = s.T.indexOf(s.P);
                                a - 1 >= 0 && (s.P = s.T[a - 1]), t()
                            } else "Enter" === e.key ? r.P ? (e.stopPropagation(), i(r.P)) : (e.stopPropagation(), n(), l()) : "Esc" !== e.key &&
                                "Escape" !== e.key || (e.stopPropagation(), n(), l())
                        }), this.R = p, this.S = m, this.O || (this.O = this.data[0],
                            this.O && (p.value = this.O.name)), c.appendChild(p), c.appendChild(u), c.appendChild(h), c.appendChild(m), c
                ...
                s.prototype.X = function () {
                    ...
                    if (this.U.value = this.selected ? this.selected.id : null, this.O ? this.R.value = this.O.name : this.R.value = "",
            ...
            var c = function (e) {
                this.form = null, this.item = null, this.data = null, this.name = null, this.theme = "edit_table_default",
                    this.onInput = null, this.nav = {}, this.Y = null, this.D = [], e = e || {};
                for (var t in e) this[t] = e[t]
            };
            c.prototype.create = function () {
                    ...
                    var r = document.createElement("div");
                    t.appendChild(r), this.nav.body = d, this.nav.table = i, this.nav.main = t,
                        this.nav.after = r;
                    var s = document.createElement("div"),
                ...
                c.prototype.fa = function (e) {
                    ...
                    return n.className = this.theme + "_delete", n.addEventListener("click",
                        function (a) {
                ...
                c.prototype.ia = function (e) {
                    ...
                    if ("text" === a || "number" === a) {
                        var i = document.createElement("input");
                        return i.type = a, t.disabled && (i.disabled = !0), e.value && (i.value = e.value), i.addEventListener("keyup",
                            function (i) {
                    ...
                    if ("select" === a) {
                        ...
                        return t.disabled && (n.disabled = !0), e.data.options.forEach(function (t) {
                            ...
                            a.innerText = t.name, a.value = t.id, a.M = t.id, n.appendChild(a),
            ...
            t.Month = function (e, i) {
                    ...
                    this.id = e,
                        ...
                        this.a = function (t, e) {
                            ...
                            return t.CallBackRedirect ?
                                ...
                                (n.events.list = t.Events,
                                    "Full" === t.UpdateType && (n.startDate = t.StartDate, n.timeFormat = t.TimeFormat ?
                                        t.TimeFormat :
                                        n.timeFormat, "undefined" != typeof t.WeekStarts && (n.weekStarts = t.WeekStarts), n.hashes = t.Hashes),
                                    n.b(), n.c(), n.d(), "Full" === t.UpdateType &&
                                    (n.f(), n.g()), n.h(), n.show(), n.i(), void n.fireAfterRenderDetached(t.CallBackData, !0))
                        },
                        ...
                        this.events.load = function (t, e, i) {
                            ...
                            if (n.eventsLoadMethod &&
                                "POST" === n.eventsLoadMethod.toUpperCase()) DayPilot.Http.ajax({
                                "method": "POST",
                                "data": {
                                ...
                                for (var i = 0; i < t.length; i++) {
                                    ...
                                    if (!(s.getTime() > a.getTime()))
                                        for (var e = 0; e < this.rows.length; e++) {
                                            ...
                                            l.belongsHere(o) && (l.events.push(o),
                                                "function" == typeof this.onBeforeEventRender && (o.cache = this.p.events[i]))
                                        }
                                }
                        ...
                        this.drawShadow = function (e, i, n, s, a, l) {
                            ...
                            i < 0 && (i = 0, e = 0);
                            var c = null;
                            for (t.resizingEvent ? c = "w-resize" : t.movingEvent && (c = "move"),
                                this.nav.top.style.cursor = c; o > 0 && i < this.rows.length;) {
                                var d = Math.min(this.getColCount() - e, o),
                                    v = this.rows[i],
                                    u = this.getRowTop(i),
                                    f = v.getHeight(),
                                    p = document.createElement("div");
                                p.setAttribute("unselectable", "on"), p.style.position = "absolute", p.style.left = this.getCellWidth() * e + "%",
                                    p.style.width = this.getCellWidth() * d + "%", p.style.top = u + "px", p.style.height = f + "px", p.style.cursor = c;
                                var g = document.createElement("div");
                                g.setAttribute("unselectable", "on"), p.appendChild(g), g.style.position = "absolute",
                                    g.style.top = "0px", g.style.right = "0px", g.style.left = "0px", g.style.bottom = "0px", g.style.backgroundColor = "#aaaaaa",
                                    g.style.opacity = .5, g.style.filter = "alpha(opacity=50)", this.nav.top.appendChild(p),
                                    this.shadow.list.push(p), o -= d + 7 - this.getColCount(), e = 0, i++
                            }
                            ...
                            d.setAttribute("unselectable", "on"),
                                d.style.height = this.eventHeight + "px", d.className = this.u("_event"), i.cssClass && DayPilot.Util.addClass(d, i.cssClass),
                                e.part.startsHere || DayPilot.Util.addClass(d, this.u("_event_continueleft")),
                                e.part.endsHere || DayPilot.Util.addClass(d, this.u("_event_continueright")), d.event = e, d.style.width = h + "%",
                                d.style.position = "absolute", d.style.left = r + "%", d.style.top = c + "px",
                                this.showToolTip && e.client.toolTip() && (d.title = e.client.toolTip()), d.onclick = n.w, d.oncontextmenu = n.z,
                                d.onmousedown = function (i) {
                                    i = i || window.event;
                                    var r = i.which || i.button;
                                    if (i.cancelBubble = !0,
                                        i.stopPropagation && i.stopPropagation(), 1 === r)
                                        if (t.movingEvent = null, "w-resize" === this.style.cursor || "e-resize" === this.style.cursor) {
                                            var h = {};
                                            h.start = {}, h.start.x = l, h.start.y = s, h.event = d.event,
                                        ...
                                        u && (f += u);
                                        var p = {};
                                        p.start = {}, p.start.x = l, p.start.y = s, p.start.line = a,
                                            p.offset = n.eventMoveToPosition ? 0 : f, p.colWidth = o, p.event = d.event, p.coords = c, t.movingEvent = p
                                    }
                                    ...
                                    if ("undefined" != typeof t && !t.movingEvent && !t.resizingEvent) {
                                        ...
                                        if (n) {
                                            ...
                                            var s = 6;
                                            n.x <= s && e.client.resizeEnabled() ? e.part.startsHere ?
                                                (d.style.cursor = "w-resize", d.dpBorder = "left") :
                                                d.style.cursor = "not-allowed" :
                                                d.clientWidth - n.x <= s && e.client.resizeEnabled() ?
                                                e.part.endsHere ? (d.style.cursor = "e-resize", d.dpBorder = "right") :
                                                d.style.cursor = "not-allowed" : d.style.cursor = "default"
                                        }
                                    }
                            ...
                            if (v.setAttribute("unselectable", "on"), v.className = this.u("_event_inner"),
                                "darker" === i.borderColor && i.backColor ?
                                v.style.borderColor = DayPilot.ColorUtil.darker(i.backColor, 2) :
                                v.style.borderColor = i.borderColor, i.backColor && (v.style.background = i.backColor,
                                    (DayPilot.browser.ie9 || DayPilot.browser.ielt9) && (v.style.filter = "")),
                                i.fontColor && (v.style.color = i.fontColor), v.innerHTML = e.client.html(), d.appendChild(v),
                                e.client.barVisible()) {
                                var u = document.createElement("div");
                                u.setAttribute("unselectable", "on"), u.className = this.u("_event_bar"),
                                    u.style.position = "absolute";
                                var f = document.createElement("div");
                                f.setAttribute("unselectable", "on"),
                                    f.className = this.u("_event_bar_inner"), f.style.top = "0%", f.style.height = "100%", i.barColor && (f.style.backgroundColor = i.barColor), u.appendChild(f), d.appendChild(u)
                            }
                            if (e.client.deleteEnabled()) {
                                var p = Math.floor(n.eventHeight / 2 - 9),
                                    g = document.createElement("div");
                                g.style.position = "absolute", g.style.right = "2px", g.style.top = p + "px", g.style.width = "18px", g.style.height = "18px", g.className = n.u("_event_delete"), g.onmousedown = function (t) {
                                    t.stopPropagation()
                                }, g.onclick = function (t) {
                                    t.stopPropagation();
                                    var e = this.parentNode.event;
                                    e && n.A(e)
                                }, g.style.display = "none", d.deleteIcon = g, d.appendChild(g)
                            }
                    ...
                    if (t.movingEvent) {
                        ...
                        var e = e || window.event;
                        return n.K(s, a.x, a.y, o, e, l), e.cancelBubble = !0,
                            e.stopPropagation && e.stopPropagation(), t.movingEvent = null, !1
                    }
                    if (t.resizingEvent) {
    ...
    function () {
        if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
            DayPilot.Navigator = function (t, e) {
                    this.v = "2022.3.415-lite";
                    var i = this;
                    this.id = t, this.api = 2, this.isNavigator = !0, this.autoFocusOnClick = !0, this.weekStarts = "Auto",
                        this.selectMode = "Day", this.titleHeight = 30, this.dayHeaderHeight = 30, this.bound = null, this.cellWidth = 30,
                        this.cellHeight = 30, this.cssClassPrefix = "navigator_default", this.freeHandSelectionEnabled = !1, this.selectionStart = (new DayPilot.Date).getDatePart(), this.selectionEnd = null, this.selectionDay = null, this.showMonths = 1, this.skipMonths = 1, this.command = "navigate", this.year = (new DayPilot.Date).getYear(), this.month = (new DayPilot.Date).getMonth() + 1, this.showWeekNumbers = !1, this.weekNumberAlgorithm = "Auto", this.rowsPerMonth = "Six", this.orientation = "Vertical", this.locale = "en-us", this.rtl = !1, this.visible = !0, this.timeRangeSelectedHandling = "Bind", this.visibleRangeChangedHandling = "Enabled", this.onVisibleRangeChange = null, this.onVisibleRangeChanged = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.nav = {}, this.a = {}, this.b = function () {
